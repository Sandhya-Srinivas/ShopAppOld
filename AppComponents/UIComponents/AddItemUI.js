...
const AddItemUI=(props)=>{
  ...
  const callbackSetCost = useCallback( (input, type)=>{
    ...
    const handleSubmit = ()=> {
      if(!props.noExpiry && !props.expiryInDays && !props.expiryAsDate){
        return Snackbar.show({
          ...
          <Item style={{width: "95%", alignSelf: 'center'}}>  
            ...
            <Left>  
              ...
              {unitFlag? 
                ...
                /> 
                : <Input value={null} onFocus={()=>{setTotalFlag(false); setUnitFlag(true); callbackSetCostType(k.unitCost)}} />
              }              
              </Item>
            </Left>
            ...
            <Right>   
              ...
              />
              : <Input value={null} onFocus={()=>{setUnitFlag(false); setTotalFlag(true); callbackSetCostType(k.unitCost)}} />
              } 
              </Item>
            </Right>
